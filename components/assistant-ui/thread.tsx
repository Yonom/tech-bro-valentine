...
export const Thread: FC = () => {
  return (
    <ThreadPrimitive.Root
      className="bg-background box-border h-full flex flex-col"
      style={{
    ...
    >
      ...
      <ThreadPrimitive.If empty={false}>
        <ThreadPrimitive.Viewport className="flex flex-grow flex-col items-center overflow-y-scroll scroll-smooth bg-inherit px-4 pt-8">
          ...
          <div className="max-w-[var(--thread-max-width)] sticky bottom-0 mt-3 flex w-full flex-col items-center justify-end rounded-t-2xl bg-inherit pb-4">
...
const ThreadWelcome: FC = () => {
  return (
    <ThreadPrimitive.Empty>
      <div className="w-full h-full flex flex-col items-center justify-center mx-4">
    ...
    <div className="mt-3 flex w-full items-stretch justify-center gap-4 flex-wrap">
      {suggestions.map((suggestion, idx) => (
        <ThreadPrimitive.Suggestion
          key={idx}
          className="hover:bg-muted/80 flex max-w-sm grow basis-0 flex-col items-center justify-center rounded-full border-2 border-primary px-3 py-2 transition-colors ease-in  whitespace-nowrap"
          prompt={suggestion}
          method="replace"
          autoSend
        >
...
const Composer: FC = () => {
  return (
    <ComposerPrimitive.Root className="focus-within:border-ring/20 flex w-full flex-wrap items-end rounded-3xl border bg-inherit px-2.5 shadow-sm transition-colors ease-in">
      ...
      <ThreadPrimitive.If running={false}>
        <ComposerPrimitive.Send asChild>
          <TooltipIconButton
            tooltip="Send"
            variant="default"
            className="my-2.5 size-8 p-2 transition-opacity ease-in rounded-full"
          >
            <SendHorizontalIcon />
          </TooltipIconButton>
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="grid grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] relative w-full max-w-[var(--thread-max-width)] py-4">
      <div className="text-foreground max-w-[calc(var(--thread-max-width)*0.9)] break-words leading-7 col-span-2 col-start-2 row-start-1 my-1.5">
